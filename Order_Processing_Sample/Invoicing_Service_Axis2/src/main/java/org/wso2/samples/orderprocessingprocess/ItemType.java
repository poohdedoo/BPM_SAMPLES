...
public class ItemType implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = itemType
	 * Namespace URI = http://www.wso2.org/samples/OrderProcessingProcess/
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":itemType", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"itemType", xmlWriter);
			...
			try {
						...
						if (!"itemType".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ItemType) org.wso2.samples.invoicingservice.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
						...
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "itemID" + "  cannot be null");
					}
