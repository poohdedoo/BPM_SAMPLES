...
public class InvoiceType implements org.apache.axis2.databinding.ADBBean {
	...
	protected org.wso2.samples.orderprocessingprocess.ItemsType localItems;

	/**
	 * Auto generated getter method
	 * 
	 * @return org.wso2.www.samples.orderprocessingprocess.ItemsType
	 */
	public org.wso2.samples.orderprocessingprocess.ItemsType getItems() {
		return localItems;
	}
	 ...
	 *            Items
	 */
	public void setItems(org.wso2.samples.orderprocessingprocess.ItemsType param) {
	...
	protected java.lang.String localShippingAddress;
	 ...
	 *            ShippingAddress
	 */
	public void setShippingAddress(java.lang.String param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		localItems.serialize(
				new javax.xml.namespace.QName(
						"http://www.wso2.org/samples/OrderProcessingProcess/",
						"items"), xmlWriter);

		namespace = "http://www.wso2.org/samples/OrderProcessingProcess/";
		writeStartElement(null, namespace, "shippingAddress", xmlWriter);
		...
		if (localShippingAddress == null) {
			...
			xmlWriter.writeCharacters(localShippingAddress);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localShippingAddress != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localShippingAddress));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"shippingAddress cannot be null!!");
		}
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://www.wso2.org/samples/OrderProcessingProcess/", "city"));
		...
		public static InvoiceType parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"invoiceType".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (InvoiceType) org.wso2.samples.invoicingservice.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setItems(org.wso2.samples.orderprocessingprocess.ItemsType.Factory
							.parse(reader));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://www.wso2.org/samples/OrderProcessingProcess/",
								"shippingAddress").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "shippingAddress"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setShippingAddress(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
